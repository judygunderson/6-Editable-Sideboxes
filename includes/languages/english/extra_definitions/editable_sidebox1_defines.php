<?php
/**
 * editable sidebox definitions - parameters for an admin-editable sidebox
 *
...
define('BOX_HEADING_EDITABLE_SIDEBOX1', 'Shop With Confidence!');
...
define('DEFINE_EDITABLE_SIDEBOX1_NAME', 'define_editable_sidebox1_content');
